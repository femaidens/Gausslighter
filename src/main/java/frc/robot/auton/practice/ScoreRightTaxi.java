...
public class ScoreRightTaxi extends SequentialCommandGroup {
  //starting @ left/right, facing nodes 
  public ScoreRightTaxi(Drivetrain drivetrain, Intake intake, ArmAngle armAngle, ArmLateral armLateral) {
